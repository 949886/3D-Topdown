...
namespace JUTPS.JUInputSystem
{
	...
	[AddComponentMenu("JU TPS/Input/JU Input Manager1")]

	public class JUInputManager1 : MonoBehaviour, JUTPSInputControlls.IPlayerActions
	{
        ...
        JUTPSInputControlls controls;

        public void OnEnable()
        {
            if (controls == null)
            {
                controls = new JUTPSInputControlls();
